...
public class BaiduPush {
	...
	private final static int HTTP_CONNECT_TIMEOUT = 5000;// 连接超时时间，5s
	private final static int HTTP_READ_TIMEOUT = 5000;// 读消息超时时间，5s
	
	public String mHttpMethod;// 请求方式，Post or Get
	public String mSecretKey;// 安全key

	public final static String API_KEY = "6hmAYRfFP5vGt9LK9VEIRn2T";
	public final static String SECRIT_KEY = "3tLYTFwbGGtasquDisjX0rAoFAXqnUh6";

	private static BaiduPush mBaiduPush;

	public static synchronized BaiduPush getBaiduPush() {
		if (mBaiduPush == null) {
			mBaiduPush = new BaiduPush(HTTP_METHOD_POST, SECRIT_KEY, API_KEY);
		}
		return mBaiduPush;
	}
